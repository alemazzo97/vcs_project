...
ABOUT THE GRAPHICS.
There is a folder that provides all the graphics about the loss and accuracy evolution of the models

ABOUT THE TEX.
in the tex folder there are all the images and the files necessary to execute the .tex file and get the report.
